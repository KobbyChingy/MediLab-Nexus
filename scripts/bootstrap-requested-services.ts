...
const requestedServices: RequestedService[] = [
  {
    code: "LAB-LFT",
    name: "Liver Function Test (LFTs)",
    priceCents: 16800,
    tatMinutes: 180,
    modality: "",
    rulesTemplate: "lab-standard",
  },
  {
    code: "LAB-RFT",
    name: "Kidney Function Test (RFTs/BUN)",
    priceCents: 11800,
    tatMinutes: 180,
    modality: "",
    rulesTemplate: "lab-standard",
  ...
  {
    code: "LAB-ELECTROLYTES",
    name: "Electrolytes Panel (Na, K, Cl, HCO3)",
    priceCents: 22000,
    tatMinutes: 120,
    modality: "",
    rulesTemplate: "lab-standard",
